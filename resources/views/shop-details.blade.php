        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <a href="{{route('cart',['id' => $product->id])}}" class="primary-btn">ADD TO CARD</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{$relat->image}}">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{route('detail', ['id' => $relat->id])}}">{{$relat->name}}</a></h6>
                        <h5>{{number_format($relat->price)}} VNĐ</h5>
                    </div>
                </div>
            </div>
            @endforeach
